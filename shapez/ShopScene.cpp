...
void ShopScene::paintEvent(QPaintEvent *e)
{
    ...
    // 更大的hub
    painter.drawText(100 * 1 + ButtonSize * 0 + 14, WIDGET_HEIGHT / 2 - 120, QString("Bigger Hub"));
    ...
    // 清空障碍
    painter.drawText(100 * 2 + ButtonSize * 1 + 14, WIDGET_HEIGHT / 2 - 120, QString("Clear Barriers"));
    ...
    // 增加矿地
    painter.drawText(100 * 3 + ButtonSize * 2 + 14, WIDGET_HEIGHT / 2 - 120, QString("Add Mines"));
    ...
    // 升级item
    painter.drawText(100 * 4 + ButtonSize * 3 + 14, WIDGET_HEIGHT / 2 - 120, QString("Upgrade Item"));
    ...
    // 返回游戏
    painter.drawText(WIDGET_WIDTH - 155, WIDGET_HEIGHT - 165, QString("Leave"));
